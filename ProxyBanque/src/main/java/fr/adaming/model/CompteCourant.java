...
public class CompteCourant extends Compte implements Serializable {
	...
	public CompteCourant(double decouvert, Client client) {
		super();
		this.decouvert = decouvert;
		this.client = client;
	}
	public CompteCourant(int id, double decouvert, Client client) {
		super();
		this.id = id;
		this.decouvert = decouvert;
		this.client = client;
	...
	public String toString() {
		return "CompteCourant [id=" + id + ", decouvert=" + decouvert + ", client=" + client + "]";
	}
}
